...
interface ExportarDialogProps { cursos: Curso[]; actividades: BloqueActividad[]; }

export function ExportarDialog({ cursos, actividades }: ExportarDialogProps) {
  ...
  return <Dialog open={abierto} onOpenChange={setAbierto}>
    <DialogTrigger asChild><Button size="sm" variant="outline" className="gap-1.5 border-primary/20 bg-card shadow-sm hover:bg-accent"><Download className="size-4" /> <span className="hidden sm:inline">Exportar</span></Button></DialogTrigger>
